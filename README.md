...
Отдельную сущность `WatchHistory` в этой логической схеме не выделяю: для продуктового сценария Кинопоиска достаточно хранить актуальный прогресс в `WatchProgress`, а полную событийную историю просмотра при необходимости логичнее уводить в отдельный аналитический контур.

Такой набор сущностей и хранилищ нужен именно для моей модели Кинопоиска:
