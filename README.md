...
В данном разделе рассматриваются только те алгоритмы, способ реализации которых напрямую влияет на архитектуру сервиса, выбор хранилищ и профиль нагрузки.
