...
Так как сервис ещё не реализован и фактических нагрузочных тестов нет, расчёт выполняется по инженерным оценкам.

| Тип нагрузки | Оценка производительности |
|---|---:|
| Лёгкое JSON API на `Go` | `~2000 RPS / vCPU` |
| API с композиционной логикой | `~1000 RPS / vCPU` |
...
|---|---:|---:|---:|---:|
| Москва | `~1080 Гбит/с` | `ceil(1080 / 100) = 11` | 1 | 12 |
| Санкт-Петербург | `~228 Гбит/с` | `ceil(228 / 100) = 3` | 1 | 4 |
| Ростов-на-Дону | `~240 Гбит/с` | `ceil(240 / 100) = 3` | 1 | 4 |
| Екатеринбург | `~408 Гбит/с` | `ceil(408 / 100) = 5` | 1 | 6 |
| Новосибирск | `~300 Гбит/с` | `ceil(300 / 100) = 3` | 1 | 4 |
| Владивосток | `~144 Гбит/с` | `ceil(144 / 100) = 2` | 1 | 3 |
